# -*- coding: utf-8 -*-
#
# confidant documentation build configuration file
#
...
if not os.environ.get('CONFIDANT_DOCS_RELEASE_LEVEL'):
  raise Exception("CONFIDANT_DOCS_RELEASE_LEVEL env var must be defined")

release_level = os.environ['CONFIDANT_DOCS_RELEASE_LEVEL']
blob_sha = os.environ['CONFIDANT_BLOB_SHA']
...
if not os.environ.get('CONFIDANT_DOCS_VERSION_STRING'):
  raise Exception("CONFIDANT_DOCS_VERSION_STRING env var must be defined")

# The short X.Y version.
version = os.environ['CONFIDANT_DOCS_VERSION_STRING']
# The full version, including alpha/beta/rc tags.
release = os.environ['CONFIDANT_DOCS_VERSION_STRING']
...
htmlhelp_basename = 'confidantdoc'
